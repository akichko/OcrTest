...
def load_settings(yaml_path="app_setting.yml"):
    ...
    return settings["openai"]["endpoint"], settings["openai"]["key"]

def extract_order_info(user_content: str, yaml_path="app_setting.yml"):
    # endpoint, key をsetting.ymlから取得
    endpoint, key = load_settings(yaml_path)
